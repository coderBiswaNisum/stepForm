...
import { addressFields,permanentAddressNames,residenceAddressNames } from "../assets/objectsList";
...
function AddressForm() {
  ...
  return (
    <div className="container">
      ...
      {!same && addressFields.map((val,i) => <InputField name={val} objKey={permanentAddressNames[i]} key={val} />)}
